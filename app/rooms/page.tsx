  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <p className="text-sm text-blue-600 mb-2">✓ Nightly, Weekly &amp; Monthly rates available</p>
        <p className="text-xs text-slate-500 mb-8">🔒 A $100 refundable security deposit authorization is required prior to check-in.</p>
